...
# # 27 6 64
# map1 = [[1, 2, 3, 4], [2, 3, 4, 5], [3, 4, 5, 6], [4, 5, 6, 7]]
# nmap1 = new_map(4, map1)
# print(solution(map1, nmap1, 2, 2, 3, 4))
# print(solution(map1, nmap1, 3, 4, 3, 4))
# print(solution(map1, nmap1, 1, 1, 4, 4))
#
# # 1 2 3 4
# map2 = [[1, 2], [3, 4]]
# nmap2 = new_map(2, map2)
# print(solution(map2, nmap2, 1, 1, 1, 1))
# print(solution(map2, nmap2, 1, 2, 1, 2))
# print(solution(map2, nmap2, 2, 1, 2, 1))
# print(solution(map2, nmap2, 2, 2, 2, 2))
