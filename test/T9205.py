...
from problems.BJ9205 import solution


class T1325(unittest.TestCase):
    def test1(self):
        self.assertEqual(solution((0, 0), (2000, 1000), [(1000, 0), (1000, 1000)]), 'happy')

    def test2(self):
        self.assertEqual(solution((0, 0), (2000, 2000), [(1000, 0), (2000, 1000)]), 'sad')
